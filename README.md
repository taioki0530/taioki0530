...
| Field | Detail |
|-------|--------|
| **Theme** | Drug discovery for Fuchs Endothelial Corneal Dystrophy (FECD) |
| **Approach** | in silico screening (molecular docking, AlphaFold2) × wet lab validation |
| **Tools** | Western blot · Cell viability assay · AutoDock Vina |
| **Event** | ARVO 2026 — Travel Grant 受賞 |
...
- 🥇 **ARVO 2026 Travel Grant 受賞**（角膜疾患 × 計算創薬）
- 🥈 **SIGNATE MUFG Data Science Challenge 2025** — 27th place (credit default prediction)
- 🏅 **松尾岩澤研究室 Deep Learning基礎講座 2025秋** — 最終課題コンペ 4位
- ⭐ **松尾岩澤研究室 AIと半導体講座** — 優秀生認定
